...
import { findLeaf, isDetachedScreen, leaves, useLayoutStore } from "@/lib/layout";
...
export function LiveSessionPage() {
  ...
  return (
    <div className="flex h-full min-w-0 flex-col">
      {/* A detached screen IS its own window: it has a native titlebar and
          holds a single screen, so the tab strip (and its overlay-titlebar
          clearance) has nothing to do here. */}
      {!isDetachedScreen && <GroupTabs />}

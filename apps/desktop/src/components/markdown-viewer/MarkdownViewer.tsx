...
const STYLES: Record<Variant, Record<string, string>> = {
  ...
  // Editorial-blog paper: warm ink on white, serif headings, brick-red accent
  // (#a94a33 — the app's warm brand). Theme-independent by design: a document reads

...
import { Code2, Download, Eye, ExternalLink, FileSearch, History, LocateFixed, Loader2, X } from "lucide-react";
import { useTranslation } from "react-i18next";
import type { FilePreviewInspector as FilePreviewInspectorT, FileRoot } from "@deeplab/shared";
...
export function FilePreviewInspector({
  ...
  /** "定位": reveal this file in the session's file browser. */
  onLocate?: () => void;
  ...
  const { t } = useTranslation(["inspector", "common", "session"]);
